...
/***/ function(module, exports, __webpack_require__) {
	...
	var actor = (0, _actor.createActor)({ counters: {} });

	var calcTotal = function calcTotal(_ref) {
	...
	actor.register("update", function ($$$, _ref2) {
	  var count = _ref2.count;
	  var _from = _ref2._from;

	  var $$1 = _extends({}, $$$, {
	    counters: _extends({}, $$$.counters, _defineProperty({}, _from, count))
	  });

	  actor.emit(calcTotal($$1));
